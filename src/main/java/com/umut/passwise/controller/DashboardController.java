...
public class DashboardController {
    ...
    @GetMapping("/access-trend")
    public ResponseEntity<List<AccessTrendDto>> getAccessTrend(@RequestParam(value = "period", defaultValue = "7") int days) {
        List<AccessTrendDto> accessTrend = dashboardService.getAccessTrend(days);
        return new ResponseEntity<>(accessTrend, HttpStatus.OK);
    }
